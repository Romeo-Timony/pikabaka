        ...
        <div className="flex items-center justify-between mt-3 px-0.5">
          <div className="flex items-center gap-1.5">
            ...
            <div className="relative">
              <button
                type="button"
                title={isMousePassthrough
                  ? 'Mouse passthrough ON — clicks go to apps below. Use Ctrl+Shift+B to turn off, Ctrl+1… for actions.'
                  : 'Mouse passthrough — clicks pass through the overlay to apps below'}
                onClick={() => {
