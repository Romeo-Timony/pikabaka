...
interface ElectronAPI {
  ...
  setOverlayClickThrough: (ignore: boolean) => Promise<{ success: boolean }>
...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  setOverlayClickThrough: (ignore: boolean) => ipcRenderer.invoke("set-overlay-click-through", ignore),
