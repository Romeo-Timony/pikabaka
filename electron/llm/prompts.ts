...
import { getQaInterviewOsPrompt } from "./loadQaInterviewOs";

/** User Interview OS — primary system prompt for optimal live answers. */
export const QA_INTERVIEW_OS_PROMPT = getQaInterviewOsPrompt();
...
/**
 * CUSTOM: What To Answer — Interview OS
 */
export const CUSTOM_WHAT_TO_ANSWER_PROMPT = QA_INTERVIEW_OS_PROMPT;

/**
 * CUSTOM: Answer Mode — Interview OS
 */
export const CUSTOM_ANSWER_PROMPT = QA_INTERVIEW_OS_PROMPT;
 ...
 * Uses the user-provided Interview Operating System (QA prompt).
 */
export const UNIVERSAL_ANSWER_PROMPT = QA_INTERVIEW_OS_PROMPT;

/**
 * UNIVERSAL: What To Answer (Strategic Response)
 * Same Interview OS — generate exactly what the candidate should say next.
 */
export const UNIVERSAL_WHAT_TO_ANSWER_PROMPT = QA_INTERVIEW_OS_PROMPT;
